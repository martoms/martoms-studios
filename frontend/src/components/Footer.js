...
const Footer = () => {
  const year = new Date(Date.now()).toLocaleString("en-US", {
    year: "numeric",
  });
  ...
  return (
    <>
        ...
        <div className="col-12 col-md-2">
          <div className="row">
            <div className="col-12 links">
              <h4>Links</h4>
              <Link to="https://github.com/martoms" target="_blank">
                <p>
              ...
              <Link
                to="https://www.upwork.com/freelancers/~010e1495f770d6ef34"
                target="_blank"
              >
                <p>
      ...
      <footer>
        <p>martoms_studios</p>
        <p>Marjohn Tomatao | Software Engineer | MERN Stack</p>
